...
SRCS =  include/glm/detail/glm.cpp  $(wildcard jsoncpp-1.9.5/lib_json/*.cpp) $(wildcard src/*.cpp)
OBJS = $(SRCS:%.cpp=%.o)
HEADERS = -Iinclude -Iglad/include/ $(shell pkg-config --cflags glfw3) $(shell pkg-config --cflags opengl)    -I./jsoncpp-1.9.5/include/ -I./jsoncpp-1.9.5/include/json/
